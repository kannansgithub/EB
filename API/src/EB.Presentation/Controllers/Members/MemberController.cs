...
using EB.Application.Features.Members.Queries;
using EB.Presentation.Shared.Filters;
using EB.Presentation.Shared.Models;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace EB.Presentation.Controllers.Members;


[Route("api/[controller]")]
public class MemberController(ISender sender, IConfiguration configuration) : BaseApiController(sender)
{
