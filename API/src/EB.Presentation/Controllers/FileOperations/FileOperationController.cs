...
using EB.Application.Features.FileOperations.Commands;
using EB.Application.Features.FileOperations.Queries;
...
namespace EB.Presentation.Controllers.FileOperations;

[Route("api/[controller]")]
public class FileOperationController(ISender sender) : BaseApiController(sender)
{
