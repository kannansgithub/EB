...
public class Config : BaseEntityCommon, IAggregateRoot
{
    ...
    public Config(string? userId, string name, string? description,
       string currencyId, string smtpHost, int smtpPort, string smtpUserName,
       string smtpPassword, bool smtpUseSSL, bool active
