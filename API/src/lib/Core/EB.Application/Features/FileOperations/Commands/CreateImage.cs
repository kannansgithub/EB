...
public class CreateImageHandler(IImageService uploadImage) : IRequestHandler<CreateImageRequest, CreateImageResult>
{
    private readonly IImageService _uploadImage = uploadImage;
