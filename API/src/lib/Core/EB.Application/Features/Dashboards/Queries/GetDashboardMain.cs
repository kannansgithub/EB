...
namespace EB.Application.Features.Dashboards.Queries;
...
public class GetDashboardMainHandler(
    IQueryContext context,
    IMapper mapper
        ) : IRequestHandler<GetDashboardMainRequest, GetDashboardMainResult>
{
